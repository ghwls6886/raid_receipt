...
/** 무료 베타 pill — 클릭 시 크레딧(무료 안내) 화면으로. 정식 출시 때 크레딧 잔량으로 복원 */
function CreditPill() {
  const navigate = useNavigate();
  return (
    <button
      className="border-border-subtle hover:bg-bg-hover text-brand-600 mr-1 rounded-full border px-3 py-1.5 text-xs font-semibold"
